...
CREATE TABLE `event` (
  ...
  KEY `room_id` (`room_id`),
  CONSTRAINT `event_ibfk_16` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `event_ibfk_17` FOREIGN KEY (`event_rates_id`) REFERENCES `event_rates` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `event_ibfk_18` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `event` VALUES (1,'Lebaran','2023-03-12','2023-03-13',5,1,1);
...
INSERT INTO `event_rates` VALUES (1,10,0);
...
CREATE TABLE `location` (
  ...
  CONSTRAINT `location_ibfk_11` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `location_ibfk_12` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON UPDATE CASCADE
...
CREATE TABLE `property` (
  ...
  KEY `type_id` (`type_id`),
  CONSTRAINT `property_ibfk_11` FOREIGN KEY (`tenant_id`) REFERENCES `tenant` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `property_ibfk_12` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `property_connector` (
  ...
  CONSTRAINT `property_connector_ibfk_10` FOREIGN KEY (`property_accommodation_id`) REFERENCES `property_accommodation` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `property_connector_ibfk_9` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `property_connector` VALUES (1,1,NULL);
...
CREATE TABLE `review` (
  ...
  CONSTRAINT `review_ibfk_11` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `review_ibfk_12` FOREIGN KEY (`transactions_history_id`) REFERENCES `transactions_history` (`id`) ON UPDATE CASCADE
...
INSERT INTO `room` VALUES (1,'Executive','penjelasan tentang roomnya',2,700000,1,NULL),(2,'One Bedroom','penjelasan tentang roomnya',2,500000,1,NULL),(3,'One Bedroom','penjelasan tentang roomnya',2,500000,2,NULL),(4,'Studio','penjelasan tentang roomnya',2,500000,2,NULL),(5,'One Bedroom','penjelasan tentang roomnya',2,500000,3,NULL),(6,'Studio Queen','penjelasan tentang roomnya',2,500000,3,NULL),(7,'One Bedroom','penjelasan tentang roomnya',2,500000,4,NULL),(8,'Standard','penjelasan tentang roomnya',2,500000,4,NULL),(9,'Superior','penjelasan tentang roomnya',2,500000,5,NULL),(10,'Twin','penjelasan tentang roomnya',2,500000,5,NULL),(11,'Comfy','penjelasan tentang roomnya',2,500000,6,NULL),(12,'Elegant','penjelasan tentang roomnya',2,500000,6,NULL),(13,'Large','penjelasan tentang roomnya',2,500000,7,NULL),(14,'Medium','penjelasan tentang roomnya',2,500000,7,NULL),(15,'King','penjelasan tentang roomnya',2,500000,8,NULL),(16,'Master','penjelasan tentang roomnya',2,500000,8,NULL),(17,'Family','penjelasan tentang roomnya',2,500000,9,NULL),(18,'Premier','penjelasan tentang roomnya',2,500000,9,NULL),(19,'Resident','penjelasan tentang roomnya',2,500000,10,NULL),(20,'Studio','penjelasan tentang roomnya',2,500000,10,NULL),(21,'Deluxe','penjelasan tentang roomnya',2,500000,11,NULL),(22,'Suite','penjelasan tentang roomnya',2,500000,11,NULL),(23,'Deluxe','penjelasan tentang roomnya',2,500000,12,NULL),(24,'Junior Suite','penjelasan tentang roomnya',2,500000,12,NULL),(25,'Master','penjelasan tentang roomnya',2,500000,13,NULL),(26,'Superior Twin','penjelasan tentang roomnya',2,500000,13,NULL),(27,'Master','penjelasan tentang roomnya',2,500000,14,NULL),(28,'Queen','penjelasan tentang roomnya',2,500000,14,NULL),(29,'Deluxe','penjelasan tentang roomnya',2,500000,15,NULL),(30,'One Bedroom','penjelasan tentang roomnya',2,500000,15,NULL),(31,'Deluxe','penjelasan tentang roomnya',2,500000,16,NULL),(32,'Super King','penjelasan tentang roomnya',2,500000,16,NULL),(33,'Deluxe','penjelasan tentang roomnya',2,500000,17,NULL),(34,'One Bedroom','penjelasan tentang roomnya',2,500000,17,NULL),(35,'One Bedroom','penjelasan tentang roomnya',2,500000,18,NULL),(36,'Studio','penjelasan tentang roomnya',2,500000,18,NULL),(37,'One Bedroom','penjelasan tentang roomnya',2,500000,19,NULL),(38,'Studio','penjelasan tentang roomnya',2,500000,19,NULL),(39,'One Bedroom','penjelasan tentang roomnya',2,500000,20,NULL),(40,'Studio','penjelasan tentang roomnya',2,500000,20,NULL),(41,'Master','penjelasan tentang roomnya',2,500000,21,NULL),(42,'Twin','penjelasan tentang roomnya',2,500000,21,NULL),(43,'King','penjelasan tentang roomnya',2,500000,22,NULL),(44,'Super King','penjelasan tentang roomnya',2,500000,22,NULL),(45,'King','penjelasan tentang roomnya',2,500000,23,NULL),(46,'Queen','penjelasan tentang roomnya',2,500000,23,NULL),(47,'Master','penjelasan tentang roomnya',2,500000,24,NULL),(48,'Twin','penjelasan tentang roomnya',2,500000,24,NULL),(49,'Club','penjelasan tentang roomnya',2,500000,25,NULL),(50,'Deluxe','penjelasan tentang roomnya',2,500000,25,NULL),(51,'Deluxe','penjelasan tentang roomnya',2,500000,26,NULL),(52,'Queen','penjelasan tentang roomnya',2,500000,26,NULL),(53,'Standard','penjelasan tentang roomnya',2,500000,27,NULL),(54,'Queen','penjelasan tentang roomnya',2,500000,27,NULL),(55,'King','penjelasan tentang roomnya',2,500000,28,NULL),(56,'Twin Bed','penjelasan tentang roomnya',2,500000,28,NULL),(57,'King','penjelasan tentang roomnya',2,500000,29,NULL),(58,'Queen','penjelasan tentang roomnya',2,500000,29,NULL),(59,'Lite','penjelasan tentang roomnya',2,500000,30,NULL),(60,'Superior','penjelasan tentang roomnya',2,500000,30,NULL),(61,'Queen','penjelasan tentang roomnya',2,500000,31,NULL),(62,'Suite','penjelasan tentang roomnya',2,500000,31,NULL),(63,'Campervan','penjelasan tentang roomnya',2,500000,32,NULL),(64,'Superior','penjelasan tentang roomnya',2,500000,32,NULL),(65,'Deluxe','penjelasan tentang roomnya',2,500000,33,NULL),(66,'Superior','penjelasan tentang roomnya',2,500000,33,NULL),(67,'Master','penjelasan tentang roomnya',2,500000,34,NULL),(68,'Secondary','penjelasan tentang roomnya',2,500000,34,NULL),(69,'Master','penjelasan tentang roomnya',2,500000,35,NULL),(70,'Secondary','penjelasan tentang roomnya',2,500000,35,NULL),(71,'Primary','penjelasan tentang roomnya',2,500000,36,NULL),(72,'Secondary','penjelasan tentang roomnya',2,500000,36,NULL),(73,'Double','penjelasan tentang roomnya',2,500000,37,NULL),(74,'Queen','penjelasan tentang roomnya',2,500000,37,NULL),(75,'Single','penjelasan tentang roomnya',2,500000,38,NULL),(76,'Single Long','penjelasan tentang roomnya',2,500000,38,NULL),(77,'Adult','penjelasan tentang roomnya',2,500000,39,NULL),(78,'Kid','penjelasan tentang roomnya',2,500000,39,NULL),(79,'Master','penjelasan tentang roomnya',2,500000,40,NULL),(80,'Suite','penjelasan tentang roomnya',2,500000,40,NULL),(81,'King','penjelasan tentang roomnya',2,500000,41,NULL),(82,'Twin','penjelasan tentang roomnya',2,500000,41,NULL),(83,'Club Suite','penjelasan tentang roomnya',2,500000,42,NULL),(84,'Twin','penjelasan tentang roomnya',2,500000,42,NULL),(85,'Junior Suite','penjelasan tentang roomnya',2,500000,43,NULL),(86,'Signature','penjelasan tentang roomnya',2,500000,43,NULL),(87,'Deluxe King','penjelasan tentang roomnya',2,500000,44,NULL),(88,'Skyline King','penjelasan tentang roomnya',2,500000,44,NULL),(89,'Family','penjelasan tentang roomnya',2,500000,45,NULL),(90,'King','penjelasan tentang roomnya',2,500000,45,NULL),(91,'Master','penjelasan tentang roomnya',2,500000,46,NULL),(92,'Master Pavilion','penjelasan tentang roomnya',2,500000,46,NULL),(93,'Queen','penjelasan tentang roomnya',2,500000,47,NULL),(94,'Twin','penjelasan tentang roomnya',2,500000,47,NULL),(95,'Master','penjelasan tentang roomnya',2,500000,48,NULL),(96,'Suite','penjelasan tentang roomnya',2,500000,48,NULL),(97,'Master King','penjelasan tentang roomnya',2,500000,49,NULL),(98,'Single','penjelasan tentang roomnya',2,500000,49,NULL),(99,'Primary','penjelasan tentang roomnya',2,500000,50,NULL),(100,'Secondary','penjelasan tentang roomnya',2,500000,50,NULL),(101,'Main','penjelasan tentang roomnya',2,500000,51,NULL),(102,'Single','penjelasan tentang roomnya',2,500000,51,NULL),(103,'Master','penjelasan tentang roomnya',2,500000,52,NULL),(104,'Secondary','penjelasan tentang roomnya',2,500000,52,NULL),(105,'King','penjelasan tentang roomnya',2,500000,53,NULL),(106,'Master','penjelasan tentang roomnya',2,500000,53,NULL),(107,'Master','penjelasan tentang roomnya',2,500000,54,NULL),(108,'Single','penjelasan tentang roomnya',2,500000,54,NULL),(109,'King','penjelasan tentang roomnya',2,500000,55,NULL),(110,'Twin','penjelasan tentang roomnya',2,500000,55,NULL),(111,'King','penjelasan tentang roomnya',2,500000,56,NULL),(112,'Single','penjelasan tentang roomnya',2,500000,56,NULL),(113,'Deluxe','penjelasan tentang roomnya',2,500000,57,NULL),(114,'Suite','penjelasan tentang roomnya',2,500000,57,NULL),(115,'Horizon','penjelasan tentang roomnya',2,500000,58,NULL),(116,'Twin Deluxe','penjelasan tentang roomnya',2,500000,58,NULL),(117,'Executive','penjelasan tentang roomnya',2,500000,59,NULL),(118,'Twin','penjelasan tentang roomnya',2,500000,59,NULL),(119,'Deluxe King','penjelasan tentang roomnya',2,500000,60,NULL),(120,'Executive','penjelasan tentang roomnya',2,500000,60,NULL),(121,'Double','penjelasan tentang roomnya',2,500000,61,NULL),(122,'Master','penjelasan tentang roomnya',2,500000,61,NULL),(123,'Premier','penjelasan tentang roomnya',2,500000,62,NULL),(124,'Premier Plus','penjelasan tentang roomnya',2,500000,62,NULL),(125,'Queen','penjelasan tentang roomnya',2,500000,63,NULL),(126,'Twin','penjelasan tentang roomnya',2,500000,63,NULL),(127,'Main','penjelasan tentang roomnya',2,500000,64,NULL),(128,'Single','penjelasan tentang roomnya',2,500000,64,NULL),(129,'Studio','penjelasan tentang roomnya',2,500000,65,NULL),(130,'Studio Plus','penjelasan tentang roomnya',2,500000,65,NULL),(131,'Primary','penjelasan tentang roomnya',2,500000,66,NULL),(132,'Secondary','penjelasan tentang roomnya',2,500000,66,NULL),(133,'Studio East','penjelasan tentang roomnya',2,500000,67,NULL),(134,'Studio West','penjelasan tentang roomnya',2,500000,67,NULL),(135,'Master','penjelasan tentang roomnya',2,500000,68,NULL),(136,'Secondary','penjelasan tentang roomnya',2,500000,68,NULL),(137,'Main Room','penjelasan tentang roomnya',2,500000,69,NULL),(138,'Second','penjelasan tentang roomnya',2,500000,69,NULL),(139,'Family','penjelasan tentang roomnya',2,500000,70,NULL),(140,'Master','penjelasan tentang roomnya',2,500000,70,NULL),(141,'Master','penjelasan tentang roomnya',2,500000,71,NULL),(142,'Queen','penjelasan tentang roomnya',2,500000,71,NULL),(143,'Master','penjelasan tentang roomnya',2,500000,72,NULL),(144,'Secondary','penjelasan tentang roomnya',2,500000,72,NULL),(145,'Executive','penjelasan tentang roomnya',2,500000,73,NULL),(146,'Junior','penjelasan tentang roomnya',2,500000,73,NULL),(147,'Deluxe King','penjelasan tentang roomnya',2,500000,74,NULL),(148,'Executive King','penjelasan tentang roomnya',2,500000,74,NULL),(149,'King','penjelasan tentang roomnya',2,500000,75,NULL),(150,'Twin','penjelasan tentang roomnya',2,500000,75,NULL),(151,'President','penjelasan tentang roomnya',2,500000,76,NULL),(152,'Suite','penjelasan tentang roomnya',2,500000,76,NULL),(153,'Deluxe','penjelasan tentang roomnya',2,500000,77,NULL),(154,'Paviliun','penjelasan tentang roomnya',2,500000,77,NULL),(155,'Master','penjelasan tentang roomnya',2,500000,78,NULL),(156,'Twin','penjelasan tentang roomnya',2,500000,78,NULL),(157,'Master','penjelasan tentang roomnya',2,500000,79,NULL),(158,'Secondary','penjelasan tentang roomnya',2,500000,79,NULL),(159,'Master','penjelasan tentang roomnya',2,500000,80,NULL),(160,'Secondary','penjelasan tentang roomnya',2,300000,80,NULL);
...
CREATE TABLE `room_connector` (
  ...
  CONSTRAINT `room_connector_ibfk_10` FOREIGN KEY (`room_accommodation_id`) REFERENCES `room_accommodation` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `room_connector_ibfk_9` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `status` VALUES (1,'Confirmed'),(2,'Paid'),(3,'Cancel'),(4,'Waiting Payment'),(5,'On Going'),(6,'Stop'),(7,'Waiting Approval'),(8,'Rejected');
...
INSERT INTO `tenant` VALUES ('1','gilang','ramadhan','','tester@gmail.com','jauh','tes12345678',8888,'confirmed',14356,'2023-02-21 14:16:48','available','tenant',NULL,'2023-02-21 14:16:48','2023-02-21 14:16:48'),('2','anjar','jtp','','tester123@gmail.com','jauh juga','tes12345',8888,'confirmed',12345,'2023-02-21 14:16:48','available','tenant',NULL,'2023-02-21 14:16:48','2023-02-21 14:16:48'),('615ae9d6-6b38-426d-88cb-0d9136249a40','ginanjar','jtp',NULL,'ginanjar@gmail.com',NULL,'$2b$10$vI2WSP7Pw1ATKP3KOo1G1.21jWgO0j/IOS4botw2i95dvCpLPj/v6',888888888888,'confirmed',15670,'2023-03-20 04:13:38','Public/images/PIMG-1679285618822753513621.png','tenant',NULL,'2023-03-20 04:13:38','2023-03-20 04:13:38'),('db9d1f18-95ec-41c8-b8d8-6ecf142accb2','Gilang','Ramadhan',NULL,'gilangtester@gmail.com','dimana ya','$2b$10$YBUrEMzeye8JjpGouiJ0PecSPOA6LeLSXprgKrMaUQhz6Uo9ihySq',8222222222,'confirmed',10026,'2023-03-17 03:12:51','Public/images/PIMG-1679022771620725745157.png','tenant',NULL,'2023-03-17 03:12:51','2023-03-18 04:29:23');
...
INSERT INTO `tenant_details` VALUES (1,NULL,NULL),(3,NULL,NULL),(4,'Public/images/PIMG-1679113719914872300549.png','db9d1f18-95ec-41c8-b8d8-6ecf142accb2'),(5,NULL,'615ae9d6-6b38-426d-88cb-0d9136249a40');
...
CREATE TABLE `transactions` (
  ...
  KEY `users_id` (`users_id`),
  KEY `room_id` (`room_id`),
  CONSTRAINT `transactions_ibfk_11` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `transactions_ibfk_12` FOREIGN KEY (`room_id`) REFERENCES `room` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `transactions_history` (
  ...
  KEY `status_id` (`status_id`),
  CONSTRAINT `transactions_history_ibfk_11` FOREIGN KEY (`transactions_id`) REFERENCES `transactions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `transactions_history_ibfk_12` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `transactions_history` VALUES (63,65,4,'2023-03-17 13:56:02','2023-03-17 13:56:02'),(64,66,4,'2023-03-17 13:56:02','2023-03-17 13:56:02'),(65,67,4,'2023-03-18 04:32:20','2023-03-18 04:32:20'),(66,68,4,'2023-03-18 06:55:07','2023-03-18 06:55:07'),(67,69,4,'2023-03-18 06:55:41','2023-03-18 06:55:41'),(68,70,4,'2023-03-18 06:55:41','2023-03-18 06:55:41'),(69,71,4,'2023-03-18 14:25:12','2023-03-18 14:25:12'),(70,72,4,'2023-03-18 14:25:12','2023-03-18 14:25:12'),(71,73,4,'2023-03-19 17:21:45','2023-03-19 17:21:45'),(72,74,4,'2023-03-19 18:37:32','2023-03-19 18:37:32'),(73,75,4,'2023-03-19 18:37:32','2023-03-19 18:37:32');
...
INSERT INTO `users` VALUES ('367c3ca1-8ab4-404f-a7d7-abdbde1d7617','tester123','tester134123','confirmed','tester12321312@gmail.com','$2b$10$Zw7lqQuIQHWHtULrUpWdROtAIYq5riUgIj4p2zl.vsPgUECzrZJAG',8888888888,13266,'2023-03-14 08:45:31','user','2023-03-14 08:45:31','2023-03-18 14:33:04',NULL,NULL),('5890b6f4-54fb-4877-8d00-92e7727913e0','Gilang','','confirmed','gilang.ramadhan011297@gmail.com',NULL,82213738214,NULL,NULL,'user','2023-03-17 13:54:34','2023-03-17 13:58:56','sCs5o8h2xzf4I3Pl0lEA1rQHBhk2',1),('9beaa852-6017-4127-8dba-6c7d0f147184','tester','123','confirmed','tester123123@gmail.com','$2b$10$la1Ku96A4lzcIpWyiqV.h.Hl.H6kM6GncCTOuscfCoF71xZMmzI8e',82213738218,11864,'2023-03-10 09:02:05','user','2023-03-10 09:02:05','2023-03-19 14:49:39',NULL,NULL);
...
INSERT INTO `users_details` VALUES (1,'Male','','2023-03-01 00:00:00','Public/images/PIMG-1678855602509624377639.png','9beaa852-6017-4127-8dba-6c7d0f147184'),(7,NULL,NULL,NULL,NULL,'367c3ca1-8ab4-404f-a7d7-abdbde1d7617'),(16,'Male','','2012-05-13 00:00:00','https://lh3.googleusercontent.com/a/AGNmyxY6ehb0FZH9AXDLjnv2MWB9xY1cV8oS9HQsP09s=s96-c','5890b6f4-54fb-4877-8d00-92e7727913e0');
...
-- Dump completed on 2023-03-20 21:26:12
